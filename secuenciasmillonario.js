...
function help(parametro){	
	...
	if(parametro==1){
		for(mov=2;mov<=5;mov++){
			...
			console.log($("#boton"+bot).text()+	" / "+buena+" / "+contador+" / "+bot);
...
function funcion(parametro){
	...
	if(puntajes[aumento]==1000000){		
		...
		//console.log(datos[actual][6]+" / "+$("#boton"+parametro).text());
		//if(datos[posiciones[actual]][6]==$("#boton"+parametro).text()||datos[posiciones[actual]][6]=="Todas son corectas"||datos[posiciones[actual]][6]=="A, B y C son correctas"){
      ...
      audio.pause();
			...
			numal=generarNumerosAleatorios();    
			//console.log(buena+" / " + aumento+" / "+posiciones+"/"+numal);
			console.log(numal);
			console.log(aumento);
			console.log(datos[posiciones[aumento]][1]);
			console.log(datos[posiciones[aumento]][2]);
			console.log(datos[posiciones[aumento]][3]);
			console.log(datos[posiciones[aumento]][4]);
			console.log(datos[posiciones[aumento]][5]);
			console.log(datos[posiciones[aumento]][6]);
